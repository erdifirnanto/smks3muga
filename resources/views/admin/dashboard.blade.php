                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                    Jumlah Vidio</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $vidio }}</div>
                            </div>
                            <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-info shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-info text-uppercase mb-1"> Jumlah Prestasi
                                </div>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-4 text-center small">
                            ...
                            <span class="mr-2">
                                <i class="fas fa-circle " style="color: #4e73df;"></i> Vidio
                            </span>
                            <span class="mr-2">
...
@push('js')
    <script type="text/javascript">
        ...
        var myPieChart = new Chart(ctx, {
            type: 'doughnut',
            data: {
                labels: ["Vidio", "Event", "Prestasi"],
                datasets: [{
                    data: [vidio, event, prestasi],
