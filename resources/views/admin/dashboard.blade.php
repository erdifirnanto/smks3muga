        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1"> Jumlah Foto
                            </div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $fotogalery }}</div>
                        </div>
                        <div class="col-auto">
                            <i class="fas fa-clipboard-list fa-2x text-gray-300"></i>
                        </div>
    ...
    <div class="row">
        ...
        <div class="col-xl-8 col-lg-7">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-dark">Jumlah Pendaftaran</h6>
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card shadow mb-4">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-success">Jumlah Data</h6>
                    <div class="dropdown no-arrow">
                        <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                        </a>
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4 text-center small">
                        <span class="mr-2">
                            <i class="fas fa-circle text-success"></i> Event Sekolah
                        </span>
                        <span class="mr-2">
                            <i class="fas fa-circle " style="color: #4e73df;"></i> Ekstrakurikuler
                        </span>
                        <span class="mr-2">
                            <i class="fas fa-circle text-info"></i> Foto Galery
                        </span>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    var ekskul = <?php echo json_encode($dataekskul); ?>;
    ...
    var myPieChart = new Chart(ctx, {
        type: 'doughnut',
        data: {
            labels: ["Ekstrakurikuler", "Event", "Foto Galery"],
            datasets: [{
                data: [ekskul, event, prestasi],
