...
<body>
    <div class="container mt-5">
        <div class="card shadow-lg p-3 mb-5 bg-body rounded" style="margin-top: 130px;">
            ...
            <div class="card-body">
                <h4 class="text-center">Selamat Anda Telah Berhasil Melakukan Pendaftaran di sekolah SMK Muhammadiyah 3 Tegaldlimo, Informasi Lebih Lanjut Akan Kami Kirim Lewat WA. </h4>
