    ...
    <div class="row">
      ...
      <div class="col-md-4 mb-4">
        <div class="team-item text-center">
          <img src="{{ asset('user/assets/images/luqman.png') }}" alt="Guru PPLG 1" style="max-width: 200px; height: auto; margin-bottom: 10px;">
      ...
      <div class="col-md-4 mb-4">
        <div class="team-item text-center">
          <img src="{{ asset('user/assets/images/guru2.jpg') }}" alt="Guru PPLG 2" style="max-width: 200px; height: auto; margin-bottom: 10px;">
